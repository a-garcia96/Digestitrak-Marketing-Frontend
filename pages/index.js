          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
            ...
            <div className="lg:py-24">
              <h2 className="text-3xl font-bold sm:text-4xl text-teal-900">
                <span className="text-teal-600">Understand</span> your condition
                better
              </h2>

              <p className="mt-4 text-gray-600">
                By logging your symptoms and tracking your dietary intake,
                DigestiTrack empowers you to identify patterns and correlations
                between your eating habits and the occurrence of GERD symptoms.
                DigestriTrack provides valuable insights into how certain foods
                and lifestyle factors may be affecting your condition.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
            ...
            <div className="lg:py-24">
              ...
              <p className="mt-4 text-gray-600">
                ...
                reactive and instead take proactive steps towards managing your
                GERD and improving your overall well-being.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="p-8 md:p-12 lg:px-16 lg:py-24">
          <div className="mx-auto max-w-xl text-center">
            ...
            <p className="hidden text-gray-900 md:mt-4 md:block">
              embark on a journey towards better digestive health. Take control
              of your condition and unlock a greater understanding of how to
              live a life free from discomfort.
            </p>
