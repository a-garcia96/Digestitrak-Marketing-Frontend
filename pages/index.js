          ...
          <div className="mx-auto max-w-2xl py-32 sm:py-48">
            <div className="text-center">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600">
                Harness the power of data with DigestiTrack. Whether you've just
                been diagnosed or have been living with GERD, we provide you
      ...
      <section className="overflow-hidden max-w-screen-xl mx-auto sm:grid sm:grid-cols-2">
        <div className="p-8 md:p-12 lg:px-16 lg:py-24">
          <div className="mx-auto max-w-xl text-center">
            <h2 className="text-2xl font-bold text-gray-900 md:text-3xl text-teal-900">
